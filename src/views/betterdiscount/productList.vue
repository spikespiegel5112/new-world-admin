...
<div class="app-container">
        ...
        <div class="queryform-wrapper">
            <div class="outside">
                ...
                <ul class="operation-wrapper pull-right">
                    ...
                    <li>
                        <el-button size="mini" class="expand el-icon-arrow-down" type="text" @click='expand'>高级搜索<i class=""></i></el-button>
                    </li>
                </ul>
            </div>
                        ...
                        <el-col :span="8">
                            <el-form-item label="商品类型：">
                                <el-select v-if="productTypeData.length>0" v-model="queryModel.type">
                                    <el-option v-for="item in productTypeData" :key="item.type" :label="item.title" :value="item.type"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
    ...
    <div class="common-pagination-wrapper">
        <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="pagination.page" :page-sizes="[10,20,30,50]" :page-size="queryModel.limit" layout="total, sizes, prev, pager, next, jumper" :total="total">
        </el-pagination>
    </div>
    <!-- 弹框 -->
                ...
                <el-form :rules="rules" ref="formData" :model="formData" label-position="right" label-width="120px">
                    ...
                    <el-form-item label="商品图片" prop="detailImage">
                        <div class="common-imguploadpreview-wrapper">
                            ...
                            <el-upload class="common-avataruploader-wrapper" ref="uploadAvatar" :action="$baseUrl+'image-upload-service/1.0.0/file/upload'" list-type="text" :multiple="true" :show-file-list="false" :before-upload="handleBeforeUpload" :on-preview="handlePreview" :before-remove="handleRemove"
                            :on-success="uploadSuccess" :on-exceed="uploadAvatarExceeded" :file-list="fileList" :data="portraitParams">
                    ...
                    <el-form-item label="商品类型" prop="type">
                        <el-select v-model="formData.type">
                            <el-option v-for="item in productTypeData" :label="item.title" :value="item.type" :key="item.type"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="是否上架" prop="status">
                        <el-select v-model="formData.status">
                            <el-option v-for="item in groundingStatusDictionary" :label="item.name" :value="item.code" :key="item.code"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item v-if="durationFlag" label="上架时间范围" prop="effectiveDuration">
                        <el-date-picker v-model="effectiveDuration" type="datetimerange" :picker-options="pickerOptions2" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" align="right">
                        </el-date-picker>
                    </el-form-item>
                </el-form>
            </el-col>
